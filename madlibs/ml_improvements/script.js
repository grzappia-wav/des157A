(function(){
    ...
    //I got rid of const myform and added const submit and const restart (at the bottom)
    const submit = document.querySelector('#send-form');
    const feedback = document.querySelector('#feedback');

    //I changed my event listen to run from submit to click, connected submit to event listener
    ...
    //added const restart, connected to event listener
